...
def train_siamese_distrib_margine(directory, version, model, train_loader, valid_loader,resize,batch_size, margine,exp_name='model_1', decay=None, lr=0.0001, epochs=10, momentum=0.99,logdir='logs',modeLoss=None, dizionario_array =None ):
        ...
        for mode in ['train','valid']:
            ...
            with torch.set_grad_enabled(mode=='train'): #abilitiamo i gradienti solo in training
                ...
                for i, batch in enumerate(loader[mode]):
                    ...
                    acc = accuracy_score(np.array(labs),np.array(etichette_predette))
                    n = batch[0].shape[0]
